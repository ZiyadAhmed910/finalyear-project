...
$sql = 'SELECT * FROM ( SELECT * FROM ( SELECT * FROM weather ORDER BY id DESC LIMIT 25 )Var1 ORDER BY id ASC; ORDER BY id DESC LIMIT 25 )Var1 ORDER BY id ASC;'
?>
            ...
            demo = {
                ...
                initDashboardPageCharts: function() {
                    ...
                    var chart_labels = [<?php
                                        $sql = "SELECT * FROM ( SELECT * FROM weather ORDER BY id DESC LIMIT 25 )Var1 ORDER BY id ASC;";
                                        $aresult = mysqli_query($conn, $sql);
                                        while ($row = mysqli_fetch_assoc($aresult)) {
                                            echo '"' . $row["id"] . '",';
                                        }
